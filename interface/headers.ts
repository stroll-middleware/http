...
// 添加: myHeaders.append("Content-Type", "image/jpeg");
// 删除: myHeaders.delete("Content-Type");
// 修改: myHeaders.set("Content-Type", "image/jpeg");
// 查看: myHeaders.get("Content-Type");
// 键对: for (const pair of myHeaders.entries()) {
//    console.log(`${pair[0]}: ${pair[1]}`);
// }
// 键对: myHeaders.forEach((value, key) => {
//    console.log(`${key} ==> ${value}`);
// });
// 查看Set-Cookie: headers.getSetCookie();
// 检查是否存在: headers.has("Content-Type");
// 获取所有key：myHeaders.keys();
// 获取所有value：myHeaders.values();
